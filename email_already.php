...
?>
    ...
    <head>
        ...
        <title>Problème d'inscription | Clinique Alkawtar</title>
    ...
    <body>
        <div class="flex items-center justify-center min-h-screen p-5 bg-blue-100 min-w-screen">
            <div class="max-w-xl p-8 text-center text-gray-800 bg-white shadow-xl lg:max-w-3xl rounded-3xl lg:p-12">
                <h3 class="text-2xl">Oups, une erreur s'est produite lors de la creation de votre compte.</h3>
                <p>Cette adresse email est dèja enregistrée, vous serez redirigé vers la page de connexion </p>
                <div class="sa">
                    <div class="sa-error">
