...
<head>
    ...
    <title>Blog | Clinique Alkawtar</title>
...
<body>
        ...
        <span class="menu-lines"><span></span></span>
                    ...
                    <div class="collapse navbar-collapse" id="mainNavigation">
                        <ul class="navbar-nav ml-auto">
                            <li class="nav__item">
                                <a href="index.html" class="nav__item-link">ACCEUIL</a>
                            </li>
                            <!-- /.nav-item -->
    ...
    =========================== -->
        <section class="page-title page-title-layout5 bg-overlay">
            <div class="bg-img"><img src="assets/images/backgrounds/5.png" alt="background"></div>
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h1 class="pagetitle__heading">Nouveautés - Santé</h1>
                        <nav>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="post-item">
                            <div class="post__img">
                                <a href="#">
                                    <img src="assets/images/blog/grid/1.jpg" class="news-image" alt="post image" loading="lazy">
                                </a>
                            </div>
                            <!-- /.post__img -->
                            <div class="post__body">
                                <div style="color: white;" class="post__meta-cat ">
                                    <a href="# ">Mental Health</a>
                                </div>
                                <!-- /.blog-meta-cat -->
                                <div class="post__meta d-flex ">
                                    <span class="post__meta-date news-date ">Jan 30, 2022</span>
                                    <a class="post__meta-author " href="# ">Martin King</a>
                                </div>
                                <h4 class="post__title news-title "><a href="# ">6 Tips to Protect Your Mental Health When You’re Sick</a></h4>

                                <p class="post__desc news-description ">It’s normal to feel anxiety, worry and grief any time you’re diagnosed with a condition that’s certainly true if you test positive for COVID-19, or are presumed to be positive...
                                </p>
                                <a href="blog-single-post.html " target="_blank " class="btn btn__secondary btn__link btn__rounded news-link ">
                                    <span>Read More</span>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 ">
                        <div class="post-item ">
                            <div class="post__img ">
                                <a href="# ">
                                    <img src="assets/images/blog/grid/2.jpg " class="news-image " alt="post image " loading="lazy ">
                                </a>
                            </div>
                            <!-- /.post__img -->
                            <div class="post__body ">
                                <div class="post__meta-cat " style="color: white;">
                                ...
                                <h4 class="post__title news-title "><a href="# ">Unsure About Wearing a Face Mask? Here’s How and Why</a></h4>
                                <p class="post__desc news-description ">That means that you should still be following any shelter-in-place orders in your community. But when you’re venturing out to the grocery store, pharmacy or hospital..
                                </p>
                                <a href="# " target="_blank " class="btn btn__secondary btn__link btn__rounded news-link ">
                                    <span>Read More</span>
                                    <i class="icon-arrow-right "></i>
                                </a>
                            </div>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 ">
                        <div class="post-item ">
                            <div class="post__img ">
                                <a href="# ">
                                    <img src="assets/images/blog/grid/3.jpg " class="news-image " alt="post image " loading="lazy ">
                                </a>
                            </div>
                            <!-- /.post__img -->
                            <div class="post__body ">
                                ...
                                <!-- /.blog-meta-cat -->
                                <div class="post__meta d-flex ">
                                    <span class="post__meta-date news-date ">Jan 28, 2022</span>
                                    <a class="post__meta-author " href="# ">Saul Wade</a>
                                </div>
                                <h4 class="post__title news-title "><a href="# ">Tips for Eating Healthy When You’re Working From Home </a></h4>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 ">
                        <div class="post-item ">
                            <div class="post__img ">
                                <a href="# ">
                                    <img src="assets/images/blog/grid/4.jpg " class="news-image " alt="post image " loading="lazy ">
                                </a>
                            </div>
                            <!-- /.post__img -->
                            <div class="post__body ">
                                ...
                                <h4 class="post__title news-title "><a href="# ">Why Coronavirus Cases Among Adults Is Bad News</a></h4>
                                <p class="post__desc news-description ">A new surge of coronavirus cases has spread across the country and while there’s still so much to learn about virus, how it’s transmitted and its long-term effects
                                </p>
                                <a href="# " target="_blank " class="btn btn__secondary btn__link btn__rounded news-link ">
                                    <span>Read More</span>
                                    <i class="icon-arrow-right "></i>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 ">
                        <div class="post-item ">
                            <div class="post__img ">
                                <a href="# ">
                                    <img src="assets/images/blog/grid/5.jpg " class="news-image " alt="post image " loading="lazy ">
                                </a>
                            </div>
                            <!-- /.post__img -->
                            <div class="post__body ">
                                ...
                                <h4 class="post__title news-title "><a href="# ">Why Do People Get Kidney Stones in the Summer? </a></h4>
                                <p class="post__desc news-description ">Summer may have just officially started, but kidney stone season began a couple of weeks ago. Doctors see an increase in kidney stone cases when the weather warms up...
                                </p>
                                <a href="blog-single-post.html " target="_blank " class="btn btn__secondary btn__link btn__rounded news-link ">
                                    <span>Read More</span>
                                    <i class="icon-arrow-right "></i>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 ">
                        <div class="post-item ">
                            <div class="post__img ">
                                <a href="# ">
                                    <img src="assets/images/blog/grid/6.jpg " class="news-image " alt="post image " loading="lazy ">
                                </a>
                            </div>
                            <!-- /.post__img -->
                            <div class="post__body ">
                                ...
                                <!-- /.blog-meta-cat -->
                                <div class="post__meta d-flex ">
                                    <span class="post__meta-date news-date ">Feb 07, 2022</span>
                                    <a class="post__meta-author " href="# ">Marie Black</a>
                                </div>
                                <h4 class="post__title news-title "><a href="# ">Do Any Drugs Really Work to Treat Coronavirus? </a></h4>
                                <p class="post__desc news-description ">While most people who get COVID-19 are able to recover at home, the rush is on to find a treatment that’s safe and effective against life-threatening cases of the disease...
                                </p>
                                <a href="# " target="_blank " class="btn btn__secondary btn__link btn__rounded news-link ">
                                    <span>Read More</span>
                                    <i class="icon-arrow-right "></i>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 ">
                            <div class="footer-widget-contact ">
                                ...
                                <ul class="contact-list list-unstyled ">
                                    ...
                                    <li class="color-body ">Boulevard Allal Ben Abdallah - Oujda - MAROC</li>
                                </ul>
